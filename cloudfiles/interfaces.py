...
class S3Interface(StorageInterface):
  ...
  def __init__(self, path, secrets=None, request_payer=None, endpoint=None,
               **kwargs):
    super(StorageInterface, self).__init__()
    global S3_POOL
    ...
    self._conn = S3_POOL[S3ConnectionPoolParams(service, path.bucket, request_payer)].get_connection(secrets, endpoint)
